                ...
                <popup ref="copy" :title="'Copy banner'" style="width: 800px; max-height: 700px;">
                    <div class="form inner-form" style="padding: 30px;">
                        <form v-if="parent.formData">
                            <div class="row">
                                <label>Code</label>
                                <textarea v-model="parent.formData.copy" style="height: 300px; width: 100%; font-family: monospace; font-size: 14px; padding: 15px;"></textarea>
                            </div>
                            <div class="row">
                                <label>Type</label>
                            ...
                            <div class="row" style="margin-top: 20px;">
                                <button class="btn" @click.prevent="copy(parent.formData.copy)" style="width: 100%; padding: 12px; font-size: 16px;">Copy code</button>
                            </div>
                        </form>
                    </div>
                </popup>
