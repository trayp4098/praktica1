export const user = {
  ...
  methods: {
    ...
    actionPayment: function() {  // ДОБАВЛЕН МЕТОД
      var self = this;
      var data = self.parent.toFormData(self.parent.formData);
      data.append('uid', this.parent.$route.params.id);
    ...
    <div class="inside-content">
      ...
      <div class="wrapper">
        ...
        <div v-if="tab==1">
          ...
          <div class="table" v-if="data.sites && data.sites.length > 0">
            <table>
              <thead>
                <tr>
                  <th class="id"></th>
        ...
        <div v-if="tab==2">
          ...
          <popup ref="payment" :title="(parent.formData && parent.formData.id) ? 'Edit payment' : 'New payment'">
            <div class="form inner-form">
              <form @submit.prevent="actionPayment()" v-if="parent.formData">  <!-- ИСПРАВЛЕНО: actionPayment() -->
                <div class="row">
                  <label>Value</label>
          ...
          <div class="table" v-if="data.payments && data.payments.length > 0">
            <table>
              <thead>
                <tr>
                  <th class="id">#</th>
        ...
        <div v-if="tab==0">
          ...
          <div class="table" v-if="data.statistics && data.statistics.length > 0">
            <table>
              <thead>
                <tr>
                  <th class="id"></th>
